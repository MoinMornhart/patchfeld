...
- Windows icon (build/icon.ico) is generated by npm run graphics in all sizes – the installer build no longer needs its own conversion
- First published Windows version with AI mentor, five courses and exam trainer (includes all changes from 0.2.3)
